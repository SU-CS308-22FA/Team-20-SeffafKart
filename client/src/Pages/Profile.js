...
export default function Profile() {
    ...
    <div className='account'>
      <div className='account-info'>
        <h1>Pofile</h1>
        <p>You can set preferred display name, create your profile and other personal settings.</p>
      </div>
      <div className='account-box'>
        <div className='account-box-img' {...getRootProps()}>
            <input {...getInputProps()}/>
            <img src={img} alt="account upload" width={150} height={150} className='account-box-img-img'/>
